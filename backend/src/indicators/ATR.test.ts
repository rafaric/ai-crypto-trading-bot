...
describe('ATR', () => {
  ...
  describe('true range calculation', () => {
    it('should calculate true range correctly for first candle', () => {
      const atr = new ATR(14);
      const candles: Candle[] = [
        { symbol: 'BTC', open: 100, high: 110, low: 95, close: 105, timestamp: 1, volume: 1 },
      ];
    ...
    it('should calculate true range with previous close', () => {
      const atr = new ATR(14);
      const prevClose = 100;
      const candle: Candle = { symbol: 'BTC', open: 102, high: 110, low: 98, close: 105, timestamp: 2, volume: 1 };
    ...
    it('should calculate true range when prev close is outside current range', () => {
      ...
      const candle: Candle = { symbol: 'BTC', open: 100, high: 105, low: 95, close: 102, timestamp: 2, volume: 1 };
  ...
  describe('calculate', () => {
    it('should return null array if insufficient candles', () => {
      const atr = new ATR(14);
      const candles: Candle[] = [
        { symbol: 'BTC', open: 100, high: 105, low: 95, close: 102, timestamp: 1, volume: 1 },
        { symbol: 'BTC', open: 102, high: 107, low: 100, close: 105, timestamp: 2, volume: 1 },
      ];
    ...
    it('should calculate ATR using Wilder\'s smoothing', () => {
      ...
      const candles: Candle[] = [
        { symbol: 'BTC', open: 100, high: 110, low: 95, close: 105, timestamp: 1, volume: 1 },
        { symbol: 'BTC', open: 105, high: 115, low: 100, close: 110, timestamp: 2, volume: 1 },
        { symbol: 'BTC', open: 110, high: 120, low: 105, close: 115, timestamp: 3, volume: 1 },
        { symbol: 'BTC', open: 115, high: 118, low: 112, close: 116, timestamp: 4, volume: 1 },
      ];
    ...
    it('should produce higher ATR for volatile candles', () => {
      ...
      const lowVolCandles: Candle[] = [
        { symbol: 'BTC', open: 100, high: 101, low: 99, close: 100, timestamp: 1, volume: 1 },
        { symbol: 'BTC', open: 100, high: 101, low: 99, close: 100, timestamp: 2, volume: 1 },
        { symbol: 'BTC', open: 100, high: 101, low: 99, close: 100, timestamp: 3, volume: 1 },
        { symbol: 'BTC', open: 100, high: 101, low: 99, close: 100, timestamp: 4, volume: 1 },
      ];

      // High volatility candles
      const highVolCandles: Candle[] = [
        { symbol: 'BTC', open: 100, high: 120, low: 80, close: 100, timestamp: 1, volume: 1 },
        { symbol: 'BTC', open: 100, high: 120, low: 80, close: 100, timestamp: 2, volume: 1 },
        { symbol: 'BTC', open: 100, high: 120, low: 80, close: 100, timestamp: 3, volume: 1 },
        { symbol: 'BTC', open: 100, high: 120, low: 80, close: 100, timestamp: 4, volume: 1 },
      ];
  ...
  describe('streaming update', () => {
    it('should throw error if update called before initialization', () => {
      const atr = new ATR(14);
      const candle: Candle = { symbol: 'BTC', open: 100, high: 105, low: 95, close: 102, timestamp: 1, volume: 1 };
    ...
    it('should update ATR with new candle using Wilder\'s smoothing', () => {
      ...
      const newCandle: Candle = { symbol: 'BTC', open: 115, high: 125, low: 110, close: 120, timestamp: 4, volume: 1 };
